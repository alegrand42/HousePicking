<template id='my-template'>
  <div class='input-group col' style='padding:0'>
    ...
    @keyup.esc='close'
    >
    <select class='form-control d-inline' style='border-width:2px;height:3em;' v-model='selectedItem' @change='manualChange' @click='manualChange'>
  ...
  computed: {
    ...
    searchedItems() {
      if(!this.searchQuery) {
        ...
        */
        if(this.addedItem !== 0) this.selectedItem = this.addedItem;
